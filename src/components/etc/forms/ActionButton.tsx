...
export default component$(
  ({ label, variant, class: className = "", ...props }: ActionButtonProps) => (
    <UnstyledButton
      class={clsx(
        "relative flex items-center justify-center gap-4 rounded-2xl px-5 py-2.5 font-medium no-underline transition-colors md:text-lg lg:rounded-2xl lg:px-6 lg:py-3 lg:text-xl",
        variant === "primary" &&
